		...
		<section className={"bg-white"}>
				...
				<form>
						<div className="mb-2 mt-10 px-10 py-">
							<label htmlFor="email" className="font-bold  text-4xl block mb-2  font-large text-white dark:text-[#F6635C]">Service name</label>
						...
						<div className="mb-6 px-10 py-5">
							<label htmlFor="number" className="font-bold  text-4xl  block mb-2 font-medium text-white dark:text-[#F6635C]">First name</label>
                        ...
                        <div className="mb-6 px-10 py-5">
							<label htmlFor="number" className="font-bold  text-4xl  block mb-2 font-medium text-white dark:text-[#F6635C]">Last name</label>
							<input align="center"  type="text" id="nume"
								className="bg-gray-50 border border-gray-300  text-4xl text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
								placeholder="Last name" required/>
						</div>
						<div className="mb-6 px-10">
							<label htmlFor="number" className="font-bold  text-4xl  block mb-2 font-medium text-white dark:text-[#F6635C]">Phone number</label>
